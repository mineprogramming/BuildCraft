...
declare namespace Callback {
    ...
    function addCallback(name: string, callback: any): void;
...
declare namespace Animation {
    ...
    function Base(x: number, y: number, z: number): void;

    function item(x: number, y: number, z: number): any;

    function Item(x: number, y: number, z: number): void;
}

declare namespace IDRegistry {
	function genItemID(id: string): any;
	function genBlockID(id: string): any;
}
...
declare namespace Block {
    ...
    function registerNeighbourChangeFunctionForID(id: any, callback: any): void

    function setupAsRedstoneReceiver(nameID: string, redstone: boolean): void
...
declare namespace BlockRenderer {
	function Model(some ?: any): void;
    function setStaticICRender(some1: any, some2: any, some3: any): any;
    function createModel(): BlockModel;
    class BlockModel {
        addBox(x0: number, x1: number, x2: number, x3: number, x4: number, x5: number, name: string, data: number): void
    }
    function enableCoordMapping(id, data, render): void
    function mapAtCoords(x: number, y: number, z: number, model: ICRender.Model): void
    function unmapAtCoords(x: number, y: number, z: number): void
}
declare namespace ICRender {
    function Model(some ?: any): void;
    function getGroup(nsme: string) : ICRenderGroup
    class Model {
        addBox(): void;
        addEntry(entry: BlockRenderer.BlockModel): ICEntry;
    }
    class ICEntry {
...
declare class ICRenderCondition {}
declare class ICEntry {}
declare class ICRenderGroup {
...
declare function alert(some?: any): any;
 ...
 * ids as values
 */
declare const BlockID: any;

/**
 * Object containing string custom block string ids as keys and their numeric
 * ids as values
 */
declare const ItemID: any;
