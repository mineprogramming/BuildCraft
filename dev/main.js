...
var TransportedLiquid = new GameObject("bc-transported-liquid", {
 ...
 render: function(pos, dirs){
  var arr = [];
  for (var a in dirs){
   arr.push({x: dirs[a].x - pos.x, y: dirs[a].y - pos.y, z: dirs[a].z - pos.z});
  }
